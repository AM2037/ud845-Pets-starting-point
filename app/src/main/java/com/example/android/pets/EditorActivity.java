...
public class EditorActivity extends AppCompatActivity {
    ...
    /**
     * Gets user input from editor and saves new pet into database.
     */
    private void insertPet() {

        // Trim deletes any trailing whitespace or extra spaces
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                insertPet();
                // Exit activity (editor) and go back to CatalogActivity
                finish();
                return true;
